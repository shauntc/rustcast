    ...
    let scene = Scene {
        ...
        elements: vec![
            ...
            Element::Sphere(Sphere {
                ...
                radius: 1.0,
                material: Material {
                    color: Coloration::Texture(load_texture(
                        "./assets/materials/planks/tbykeacs_2K_Albedo.jpg",
                    )),
                    albedo: 0.04,
                    surface: SurfaceType::Diffuse,
                    normal: SurfaceNormal::Geometry,
            ...
            Element::Sphere(Sphere {
                ...
                material: Material {
                    color: Coloration::Texture(load_texture(
                        "./assets/materials/rock/smokagcp_2K_Albedo.jpg",
                    )),
                    albedo: 0.05,
                    surface: SurfaceType::Diffuse,
                    normal: SurfaceNormal::Geometry,
            ...
            Element::Sphere(Sphere {
                ...
                material: Material {
                    color: Coloration::Texture(load_texture(
                        "./assets/materials/metal/se2abbvc_2K_Albedo.jpg",
                    )),
                    albedo: 0.20,
